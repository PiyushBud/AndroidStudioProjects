...
public class MainActivity extends AppCompatActivity {
    ...
    public void myOnClick(View v){
        if(v.getId() == R.id.Keep_Button){
            String exc_edit = ((EditText)findViewById(R.id.Exc_Edit)).getText().toString();
            ((EditText)findViewById(R.id.Exc_Edit)).setText("");
            String avg_edit = ((EditText)findViewById(R.id.Avg_Edit)).getText().toString();
            ((EditText)findViewById(R.id.Avg_Edit)).setText("");
            String bavg_edit = ((EditText)findViewById(R.id.Bavg_Edit)).getText().toString();
            ((EditText)findViewById(R.id.Bavg_Edit)).setText("");

            if(exc_edit.length() != 0){
                exc_quality = Float.parseFloat(exc_edit) / 100;
            }
            if(avg_edit.length() != 0){
                avg_quality = Float.parseFloat(avg_edit) / 100;
            }
            if(bavg_edit.length() != 0){
                bavg_quality = Float.parseFloat(bavg_edit) / 100;
            }
            updateServiceQuality();
        }
    }
